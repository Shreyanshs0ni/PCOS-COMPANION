...
export default function TodayPage() {
  ...
  const quickActions = [
    { icon: "😊", label: "Mood", value: moodEntry?.label || "Not logged", color: "primary" },
    { icon: "😴", label: "Sleep", value: sleepEntry ? `${sleepEntry.hours}h` : "Not logged", color: "accent" },
    { icon: "💧", label: "Water", value: waterEntry ? `${waterEntry.glasses} glasses` : "Not logged", color: "mint" },
